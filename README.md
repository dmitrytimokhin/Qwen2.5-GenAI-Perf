...
* Оригинальный GitHub Triton Inference Server: https://github.com/triton-inference-server/client/blob/r24.03/src/c%2B%2B/perf_analyzer/genai-perf/docs/tutorial.md
